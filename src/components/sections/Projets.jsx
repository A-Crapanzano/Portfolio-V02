...
const projects = [
  {
    ...
    description: 'Application mobile de suivi de course de voile développée pour un client professionnel. Timing en temps réel, historique de flotte et alertes live.',
  ...
  },
  {
    ...
    tags: ['Next.js', 'Socket.io', 'Docker', 'MySQL', 'MongoDB', 'Projet de groupe'],
  ...
  },
  {
    ...
    tags: ['React', 'Symfony', 'Projet de groupe'],
    github: 'https://github.com/A-Crapanzano/FindJob',
  },
  {
    title: 'Portfolio V1',
    image: '/images/portfolio-v1.svg',
    description: 'Première version de mon portfolio. À mes débuts en formation.',
    tags: ['React'],
  ...
  {
    title: 'DeepDiver',
    image: '/images/deepdiver.png',
    description: 'Jeu 2D de survie sous-marine développé en groupe avec libGDX. Le joueur guide un plongeur à travers dangers et bonus pour battre le meilleur score.',
    tags: ['Java', 'libGDX', 'Projet de groupe'],
    github: 'https://github.com/A-Crapanzano/DeepDiver-Game',
  },
  {
    title: 'Déploiement Kubernetes',
    image: '/images/kubernetes-cluster.svg',
    description: "Déploiement d'une application de vote sur cluster Kubernetes multi-nœuds (minikube) : Flask, Node.js, Redis, PostgreSQL, load balancing Traefik et monitoring cAdvisor.",
    tags: ['Kubernetes', 'Docker', 'Traefik', 'Projet de groupe'],
    github: 'https://github.com/A-Crapanzano/T-DOP-603',
  },
];
